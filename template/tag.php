                ...
                <div class="blog-post-item col-12 col-lg-4 my-3">
                    <a href="<?php the_permalink(); ?>">
                        ...
                        if (get_the_post_thumbnail_url()) {
                            ...
                            <img class="image-tab w-100 h-300px rounded position-relative d-block z-1" src="' . get_the_post_thumbnail_url() . '" alt="thumb-image-blog">
                            </div>';
                        } else {
                    ...
                    <div class="post-info mt-1">
                        <span class="post-date mb-1 fs-16"><?php echo get_the_date('F j, Y'); ?></span>
