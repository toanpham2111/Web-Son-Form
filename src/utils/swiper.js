...
slider.forEach(function (slide, index) {
  new Waypoint({
    ...
    handler: function (direction) {
      if (document.getElementById(slide.id).classList.contains('swiper-container-initialized')) {
        return;
      }
      ...
      var slide_effect = slide.dataset.slideEffect,
        ...
        slide_loopMobile = slide.dataset.slideLoop ? slidesCount > slide_number_mobile : false,
        slide_loopDesktop = slide.dataset.slideLoop ? slidesCount > slide_number_desktop : false;
      var spaceBetweenValue = slide_spaceBetween ? slide_spaceBetween : spaceBetweenValue;
      var setting = {
        ...
        if (galleryModal) {
          galleryModal.forEach((modal) => {
            modal.addEventListener('shown.bs.modal', function (e) {
              ...
              document
                .querySelector(e.relatedTarget.dataset.bsTarget + ' .loading-first')
                .classList.add('d-none');
              document
                .querySelector(e.relatedTarget.dataset.bsTarget + ' .swiper-button-prev')
                .classList.remove('d-none');
              document
                .querySelector(e.relatedTarget.dataset.bsTarget + ' .swiper-button-next')
                .classList.remove('d-none');
            });
            modal.addEventListener('hidden.bs.modal', function (e) {
              document
                ...
                .classList.remove('d-none');
              document
                .querySelector('#' + e.currentTarget.id + ' .swiper-button-prev')
                .classList.add('d-none');
              document
                .querySelector('#' + e.currentTarget.id + ' .swiper-button-next')
                .classList.add('d-none');
            });
          });
        }
